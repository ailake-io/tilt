...
const std::vector<AliasEn> kTabela = {
    ...
    {"now", "agora", "N"},
    {"to_date", "converter_data", "N"},
    {"convert_timezone", "converter_fuso", "N"},
    {"days_between", "dias_entre", "N"},
    {"add_days", "adicionar_dias", "N"},
    {"year", "ano", "N"},
    {"month", "mes", "N"},
    {"day", "dia", "N"},
    {"coalesce", "coalescer", "N"},
    {"sleep", "dormir", "N"},
    {"type_of", "tipo_de", "N"},
    {"integer", "inteiro", "NT"},
    {"boolean", "logico", "NT"},
    ...
    {"pivot", "pivotar", "M"},
    {"unpivot", "despivotar", "M"},
    {"window", "janela", "M"},
    {"split_column", "dividir_coluna", "M"},
    {"convert_timezone", "converter_fuso", "M"},
    ...
    {"order", "ordem", "A"},
    {"size", "tamanho", "A"},
    {"offset", "deslocamento", "A"},
    {"default", "padrao", "A"},
    {"names", "nomes", "A"},
    {"remove", "remover", "A"},
    {"origin", "origem", "A"},
    {"destination", "destino", "A"},
    {"keep_nulls", "manter_nulos", "A"},
    {"how", "tipo", "A"},
    {"case", "caixa", "A"},
    {"top_k", "top_k", "A"},
    {"versions", "versoes", "A"},
